...
package com.orangechain.laplace.camera;
...
import com.orangechain.laplace.camera.open.OpenCameraInterface;
...
//            framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
            framingRect = new Rect(leftOffset, leftOffset*2, leftOffset + width, leftOffset*2 + height);
